...
export default function App() {
	...
	const [colorHistory, setColorHistory] = useState(new Set());
  ...
  const handleCopyHex = useCallback(() => {
    ...
    setColorHistory((prevColorHistory) => [...prevColorHistory, currentColor]);
  }, [currentColor]);
	...
	return (
		<div className='App'>
			...
			<ColorHistory colors={[...colorHistory]} handleClick={handleColorClick} />
		</div>
	);
}
